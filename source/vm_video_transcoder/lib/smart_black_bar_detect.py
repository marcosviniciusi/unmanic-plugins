...
from vm_video_transcoder.lib.ffmpeg import StreamMapper
from vm_video_transcoder.lib.tools import (
    append_worker_log,
    available_encoders,
...
class SmartBlackBarDetect:
    def __init__(self, worker_log=None, logger: Optional[logging.Logger] = None):
        ...
        self.logger = logger or logging.getLogger("Unmanic.Plugin.vm_video_transcoder")
